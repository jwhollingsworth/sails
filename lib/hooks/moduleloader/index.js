  ...
  return {
    ...
    defaults: function (config) {
      ...
      var localConfig = {
        ...
        appPath: config.appPath ? path.resolve(config.appPath) : path.join(__dirname, '../../../../..'),
    ...
    configure: function() {
      ...
      sails.config.appPath = sails.config.appPath ? path.resolve(sails.config.appPath) : path.join(__dirname, '../../../../..');
